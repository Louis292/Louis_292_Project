...
public class AddMonayCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        // Envoyer un message au joueur cible
        target.sendMessage("Vous avez reçu " + amount + " d'argent de " + sender.getName());
        sender.sendMessage("Vous avez ajouté " + amount + " d'argent à " + playerName + "'s compte.");

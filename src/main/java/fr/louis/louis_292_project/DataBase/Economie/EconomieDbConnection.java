...
public class EconomieDbConnection {
    ...
    private void connect() {
        try {
            ...
            this.connection = DriverManager.getConnection("jdbc:mysql://" + config.getString("DataBase_Tools.ip") +  ":" + config.getInt("DataBase_Tools.port") + "/" + config.getString("DataBase_Tools.DataBase_Name"), this.economieDbCredentials.getUser(), this.economieDbCredentials.getPass());
